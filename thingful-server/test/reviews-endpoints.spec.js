...
describe('Reviews Endpoints', function() {
    ...
    describe('POST /api/reviews', () => {
        ...
        it(`responds 401 'Unauthorized request' when invalid password`, () => {
            const userInvalidPass = { user_name: testUsers[0].user_name, pasword: 'wrong' };
        ...
        it('creates an review, responding with 201 and the new review', function() {
            ...
            return supertest(app)
                ...
                .expect(res => {
                    ...
                    const expectedDate = new Date().toLocaleString({ timeZone: 'UTC' });
                    const actualDate = new Date(res.body.date_created).toLocaleString({ timeZone: 'UTC'});
                ...
                .expect(res =>
                    db
                        ...
                        .then(row => {
                            ...
                            expect(row.user_id).to.eql(test.user_id);
